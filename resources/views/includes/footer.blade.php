<footer class="ftco-footer ftco-bg-dark ftco-section img" style="background-image: url(images/bg_2.jpg); background-attachment:fixed;">
  ...
  <div class="container">
    <div class="row mb-5">
      ...
      <div class="col-md-4">
        <div class="ftco-footer-widget mb-4">
          <h2 class="ftco-heading-2 ml-5">Berita Terbaru</h2>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Sma 03 Mukomuko with <i class="icon-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">YprTech</a>
